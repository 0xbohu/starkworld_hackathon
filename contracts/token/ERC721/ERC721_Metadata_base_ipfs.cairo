...
func ERC721_Metadata_tokenURI{
        ...
        pedersen_ptr: HashBuiltin*,
        range_check_ptr
    }(token_id: Uint256, token_hash_len: felt, token_hash: felt*) -> (token_uri_len: felt, token_uri: felt*):
    alloc_locals
    ...
    return (token_uri_len=token_uri_len_temp, token_uri=token_uri_temp)
end
